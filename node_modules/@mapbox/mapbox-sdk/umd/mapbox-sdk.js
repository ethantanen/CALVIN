(function (global, factory) {
  ...
  function assertShape(validatorObj, apiName) {
    return lib.assert(lib.shape(validatorObj), apiName);
  }
  ...
  Static.getStaticImage = function(config) {
    validator.assertShape({
      ...
      coordinates: validator.required(validator.oneOfType(validator.coordinates, validator.oneOf('auto'))),
  ...
  function encodePathOverlay(o) {
    ...
    var encodedPolyline = polyline_1.encode(o.coordinates);
