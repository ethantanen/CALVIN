$(document).ready(() => {
  ...
  function makeTextBox() {
    ...
    var fullTitle = $(
      "<div style='display: block'  class='containerChat darkerChat'> <img src='otherLogo.png' alt='Avatar'  class='rightChat'> <h4 class='textRight' style='color:white'>" +
        typedInfo +
        '</h4></div>'
    );
  ...
  function makeCalvinTextBox(chatText) {
    ...
    var fullTitle = $(
      "<div style='display: block'  class='containerChat'> <img src='venteraLogo.png' alt='Avatar'> <h4 class='textLeft'>" +
        chatText +
        '</h4></div>'
    );
    $('#thingToAppend').append(fullTitle);
  ...
  function showLogin(name) {
    var objName = $("<strong id='loginName'>" + name + '</strong>');
    $('#login').append(objName);
  }
